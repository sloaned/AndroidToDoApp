 ...
 */
public class Task_ParticipantContract {
    ...
    public static final class Task_ParticipantEntry implements BaseColumns {
        ...
        public static final String TABLE_NAME = "task_participant";
